...
export enum StatusCode {
  ...
  EARLY_HINTS                       = 103, // RFC 8297 2
  OK                                = 200, // RFC 7231 6.3.1
  CREATED                           = 201, // RFC 7231 6.3.2
  ACCEPTED                          = 202, // RFC 7231 6.3.3
  NON_AUTHORITATIVE_INFORMATION     = 203, // RFC 7231 6.3.4
  ...
  PREMANENT_REDIRECT                = 308, // RFC 7238 3
  ...
  PROXY_AUTHENTICATION_REQUIRED     = 407, // RFC 7235 3.2
  ...
  PAYLOAD_TOO_LARGE                 = 413, // RFC 7231 6.5.11
  URI_TOO_LONG                      = 414, // RFC 7231 6.5.12
  UNSUPPORTED_MEDIA_TYPE            = 415, // RFC 7231 6.5.13
  RANGE_NOT_SATISFIABLE             = 416, // RFC 7233 4.4
  EXPECTATION_FAILED                = 417, // RFC 7231 6.5.14
  IM_A_TEAPOT                       = 418, // RFC 7168 2.3.3
  ...
  UPGRADE_REQUIRED                  = 426, // RFC 2817 and RFC 7231 6.5.15
